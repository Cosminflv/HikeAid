...
class FriendshipModelBuilder
  ...
  EFriendshipState? _status;
  EFriendshipState? get status => _$this._status;
  set status(EFriendshipState? status) => _$this._status = status;
